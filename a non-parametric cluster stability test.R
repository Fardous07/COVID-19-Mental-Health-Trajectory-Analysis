# ============================================================================
# CONFIGURAL AND METRIC INVARIANCE ONLY (no scalar)
# ============================================================================
...
# ------------------------------------------------------------
# 2. Define item lists (post-wave names, without 'pre_')
# ------------------------------------------------------------
ptss_post <- c(
...
# ------------------------------------------------------------
# 3. Combine pre and post data (long format)
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# 5. Function to test configural + metric invariance only
# ------------------------------------------------------------
test_configural_metric <- function(data, model_syntax, construct_name) {
  ...
  # Decision criterion: ΔCFI ≥ -0.01 and ΔRMSEA ≤ 0.015
  metric_inv <- (delta_cfi >= -0.01) & (delta_rmsea <= 0.015)
  cat("\n  Metric invariance:", ifelse(metric_inv, "HOLDS", "FAILS"), "\n")
  
  # Optional robust likelihood ratio test (if needed for manuscript)
...
# ------------------------------------------------------------
cat("\n\n============================================================\n")
cat("SUMMARY: Configural and Metric Invariance\n")
cat("(ΔCFI ≥ -0.01 and ΔRMSEA ≤ 0.015 indicate metric invariance)\n")
cat("============================================================\n")
